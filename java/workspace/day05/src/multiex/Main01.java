...
public class Main01 {
	...
	public static void main(String[] args) {
		...
		// print 사용한 방법
		for (int i = 1; i <= height2; i++) {			// for(int i = 0; i <= height2; i++) {
			for (int j = 0; j <= height2 - i; j++) {	// 		for(int j = i; j <= height2; j++) {
				System.out.print("★");					//	이렇게 j에 i를 할당하는 방법도 있다. (i가 증가할 수록 j의 값도 증가해서 반복횟수가 적어진다.)		
			}
			System.out.println("");
		}
