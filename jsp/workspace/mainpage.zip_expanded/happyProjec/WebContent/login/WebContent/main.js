...
id.addEventListener(type, function(e) {
...
function checkaddress() {
    ...
    } else if(!addressPattern.test(useradd.value) || useradd.value.indexOf(" ") > -1) {
        error[5].innerHTML = "한글 주소를 사용하세요. (특수기호, 공백 사용 불가)";
        error[5].style.display = "block";
    } else {
